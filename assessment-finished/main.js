...
//入れ替えたい文字列を格納
const storyText = '気温が華氏94度近くある暑い夏の日のことだった。そのひは本当に暑かったから:insertx:は散歩に出かけた。彼らが:inserty:に到着した時、彼らは怖がり始めた。そして:insertz:。その時ボブはあることに気がついた。— :insertx:は重さ300ポンドもあったんだ。だが、それは驚くべきことではなかった。なぜなら彼は:insertx:と友達だったからだ。';
